class KH_PersistentCargoInventories: Title
{
	...
	class Controls: Controls
	{
		...
		{
			text = "Identifier";
			tooltip = "Loadout identifier from which to derive saved cargo inventories, and to which cargo inventories will be saved when <KH_fnc_endMission> is executed.";
