class KH_UnconsciousSpectator: Title
{
	...
	class Controls: Controls
	{
		...
		class KH_DelayTitle: Title
		{
			text = "Delay";
			tooltip = "Time to wait before the player is moved into spectator mode if they remain unconscious, in seconds.";
