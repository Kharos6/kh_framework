class KH_Dynamic3DAudio: Title
{
	...
	class Controls: Controls
	{
		...
		{
			text = "Condition";
			tooltip = "Unscheduled code, executed on the server, which must return <true> in order to play the audio. Checked every time the audio has a chance to play, individually for each player. Passed arguments available through <_this> are: [_player, _emitter, _handlerId, _selectedAudio].";
