	...
	if _activated then {
        {
            [
                ...
                parseSimpleArray (["[", _logic getVariable ["KH_ModuleEquipableObjectPosition", "0, 0, 0"], "]"] joinString ""),
                parseSimpleArray (["[", _logic getVariable ["KH_ModuleEquipableObjectRotation", "0, 0, 0"], "]"] joinString ""),
                parseNumber (_logic getVariable ["KH_ModuleEquipableObjectScale", ""]),
