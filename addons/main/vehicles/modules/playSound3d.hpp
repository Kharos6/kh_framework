class KH_ModulePlaySound3D: Module_F
{
	...
	class ModuleDescription: ModuleDescription
	{
		description[] = {"Plays 3D sound from the position of this module for every synchronized player. Can be exclusively activated through a trigger or triggers. Can activate multiple times. Activated on the server."};
		sync[] = {"AnyPerson"};
		position = 1;
		direction = 0;
		optional = 0;
