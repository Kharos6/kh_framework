class KH_ModuleAddInteractionEntry: Module_F
{
	...
	class Attributes: AttributesBase
	{
		...
		{
			displayName = "Options";
			tooltip = "Array of arrays dictating the possible options available for this interaction entry through a context menu, in format: <[_name (STRING), _function (STRING)]>. If <Remote> is <true>, variable 'KH_var_currentInteractionTarget' can be used to retrieve the entity being interacted with.";
