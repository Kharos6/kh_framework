...
if (_object isNil "KH_var_equipableObjectSet") then {
	...
	[
		...
		[_exclusive],
		{
			...
			triggerCbaEvent ["KH_eve_equipableObjectExchanged", [_carrier, _target, false], "GLOBAL", false];
	...
	[
		...
		[_object, _exclusive],
		{
			...
			triggerCbaEvent ["KH_eve_equipableObjectExchanged", [_caller, _object, false], "GLOBAL", false];
